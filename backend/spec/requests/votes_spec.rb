...
RSpec.describe "/votes", type: :request do
  ...
  # VotesController, or in your router and rack
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Vote" do
        expect {
          post votes_url,
               params: { vote: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Vote" do
        expect {
          post votes_url,
               params: { vote: invalid_attributes }, as: :json
        }.to change(Vote, :count).by(0)
      end

      it "renders a JSON response with errors for the new vote" do
        post votes_url,
             params: { vote: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested vote" do
        vote = Vote.create! valid_attributes
        patch vote_url(vote),
              params: { vote: new_attributes }, headers: valid_headers, as: :json
        vote.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested vote" do
      vote = Vote.create! valid_attributes
      expect {
        delete vote_url(vote), headers: valid_headers, as: :json
      }.to change(Vote, :count).by(-1)
    end
  end
end
